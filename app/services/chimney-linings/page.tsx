...
export default function ChimneyLiningsPage() {
        ...
        <div className="relative h-full flex items-center justify-center text-center px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-warm-gray mb-8 max-w-3xl mx-auto">
              Professional chimney lining installation and repair services to improve safety and efficiency.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              <h2 className="section-title gold-underline mb-8">Expert Chimney Lining Services</h2>
              <p className="text-warm-gray text-lg mb-6 leading-relaxed">
                Chimney linings are essential for protecting your home from heat, smoke, and dangerous gases. 
                Our certified technicians provide professional chimney lining installation and repair services.
              </p>
              <p className="text-warm-gray text-lg mb-8 leading-relaxed">
                We offer a variety of chimney lining systems to meet your specific needs and ensure optimal 
                performance and safety for your fireplace system.
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-gold flex-shrink-0" />
                  <span className="text-warm-gray">Stainless steel liners</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-gold flex-shrink-0" />
                  <span className="text-warm-gray">Clay tile liners</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-gold flex-shrink-0" />
                  <span className="text-warm-gray">Cast-in-place liners</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-gold flex-shrink-0" />
                  <span className="text-warm-gray">Professional installation</span>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="aspect-square rounded-lg overflow-hidden">
                <img
                  ...
                  alt="Chimney lining installation professional at work"
          ...
          >
            ...
            <div className="relative max-w-7xl mx-auto px-6 text-center">
              <h2 className="font-playfair text-4xl md:text-5xl mb-6 tracking-wide text-black">
                Need Chimney Lining Services?
              </h2>
              <p className="text-gray-800 text-lg md:text-xl max-w-2xl mx-auto mb-8">
                Protect your home with professional chimney lining installation and repair services.
              </p>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Tell us about your chimney lining needs or any questions you have..."
                      />
                    </div>
